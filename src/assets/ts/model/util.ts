...
/// <reference path="../../../../vendor/jqlayer/layer.d.ts"/>

module webimutil {


  export class CookieHelper {
    static setCookie(name: string, value: string, exires?: number) {
      if (exires) {
        var date = new Date();
  ...
  export class Helper {
    static portraitColors = ["#e97ffb", "#00b8d4", "#82b2ff", "#f3db73", "#f0857c"];

    static cloneObject = cloneObject;

    static alertMessage = {
      error: function(message: string, time?: number) {
        jQuerylayer(message, false, time);
      },
      success: function(message: string, time?: number) {
  ...
  export class ImageHelper {
    ...
    static getThumbnail(obj: any, callback: any) {
  ...
  export class ChineseCharacter {
    static convertToABC = function(str: string) {
    ...
    static arraySearch = function(chart: string) {
    ...
    static getPortraitChar2(name: string) {
      var f: any;
      if (name) {
